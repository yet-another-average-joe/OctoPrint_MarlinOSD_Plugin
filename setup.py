...
plugin_identifier = "MarlinOSD"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "MarlinOSD"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "MarlinOSD"
...
# module
plugin_description = """Marlin UI On Screen Display Configurator"""
...
plugin_url = "https://github.com/you/MarlinOSD"
...
os.system('make -C MarlinOSD/data/c_src cleanobj')
